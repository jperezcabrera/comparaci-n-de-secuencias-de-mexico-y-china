...
file2 = read.fasta("ba1.fasta", forceDNAtolower = FALSE)
...
## Comparación de variante BA.2 (México) con la de Wuhan
...
file = read.fasta("sequence.txt", forceDNAtolower = FALSE)
file2 = read.fasta("ba2.fasta", forceDNAtolower = FALSE)
cat (length(file)%/%12, "vs", length(file2)/12, "secuencias \n")
vs = length(file2)/12
